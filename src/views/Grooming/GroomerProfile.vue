<template>
  <v-container flat>
    ...
    <v-container class="px-3">
      ...
      <v-row class="mb-3">
        <v-chip color="#AEADAB" small class="ma-2 px-3 white--text weight-700">
          Haircut
        </v-chip>
        <v-chip color="#AEADAB" small class="ma-2 px-3 white--text weight-700">
          Razor Shave
      ...
      <p class="fs14 weight-800 username">Capability Index</p>

      <v-row>
        <v-col cols="2" class="alignCenter">
          <v-avatar size="32" class="border" color="#FC8A8A">
            <v-icon color="white">
              mdi-heart
            </v-icon>
          </v-avatar>
        </v-col>
        <v-col cols="6" class="alignStart marginTop2">
          <span class="fs12 weight-700 username">
            Attitude
          </span>
          <span>
            <v-progress-linear
        ...
        <v-col class="alignStart marginTop2">
          <span class="fs12 weight-700">50</span
          ><span class="ml-1 fs12 welcome">participants</span>
        </v-col>
      </v-row>

      <v-row>
        <v-col cols="2" class="alignCenter">
          <v-avatar size="32" class="border" color="#958BFC">
            <v-icon color="white">
              mdi-heart
            </v-icon>
          </v-avatar>
      ...
      <v-row>
        <v-col cols="2" class="alignCenter">
          <v-avatar size="32" class="border" color="#A4F9FC">
            <v-icon color="white">
              mdi-heart
            </v-icon>
          </v-avatar>
      ...
      <v-row>
        <v-col cols="2" class="alignCenter">
          <v-avatar size="32" class="border" color="#FFCB91">
            <v-icon color="white">
              mdi-heart
            </v-icon>
          </v-avatar>
